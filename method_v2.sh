...
snapshot_list() {
    ...
    echo "────────────────────────────────────────────────"
    printf "  %-20s %-12s %sn" "NAME" "SIZE" "CREATED"
    echo "────────────────────────────────────────────────"
    for meta in "$snap_dir"/*.meta; do
        ...
        printf "  %-20s %-12s %sn" "$sname" "${size:-N/A}" "$created"
    done
    echo "────────────────────────────────────────────────"
    echo
}
...
show_vm_info() {
    ...
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    printf "  %-22s %sn" "🌍 OS:"           "$OS_TYPE ($CODENAME)"
    printf "  %-22s %sn" "🏷️  Hostname:"    "$HOSTNAME"
    printf "  %-22s %sn" "👤 Username:"     "$USERNAME"
    printf "  %-22s %sn" "🔑 Password:"     "$PASSWORD"
    printf "  %-22s %sn" "🔌 SSH Port:"     "$SSH_PORT"
    printf "  %-22s %sn" "🧠 Memory:"       "${MEMORY} MB"
    printf "  %-22s %sn" "⚡ CPUs:"         "$CPUS"
    printf "  %-22s %sn" "💾 Disk:"         "$DISK_SIZE"
    printf "  %-22s %sn" "🖥️  GUI Mode:"    "$GUI_MODE"
    printf "  %-22s %sn" "🌐 Port Forwards:" "${PORT_FORWARDS:-None}"
    printf "  %-22s %sn" "🔒 BIOS Mode:"    "${BIOS_MODE:-bios}"
    printf "  %-22s %sn" "📡 Remote Access:" "${REMOTE_ACCESS:-none}"
    printf "  %-22s %sn" "🔙 Background:"   "${BACKGROUND_MODE:-false}"
    printf "  %-22s %sn" "🏎️  Autostart:"   "$AUTOSTART"
    printf "  %-22s %sn" "📅 Created:"      "$CREATED"
    printf "  %-22s %sn" "💿 Image File:"   "$IMG_FILE"
    printf "  %-22s %sn" "🌱 Seed File:"    "$SEED_FILE"
